...
from .class_net import ID_Market_Net,DomainNet,Carmera_Net,ID_Duke_Net
	...
	def _init_optimizer(self):
		if 'res' in self.cnnbackbone:
			...
			self.m_c4_optimizer = optim.Adam(self.m_c4_net.parameters(), lr=self.m_2k_learn_rate,
			                                 weight_decay=self.weight_decay)
			self.camera_optimizer = optim.Adam(self.carmera_net.parameters(), lr=self.d_domain_learn_rate,
			                                 weight_decay=self.weight_decay)
